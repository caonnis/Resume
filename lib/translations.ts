export const translations = {
    ...
    experiences: [
      ...
      },
      {
        ...
        details: [
          ...
          "Root cause analysis of defects and implementing corrective Actions",
          "Collaborating with developers to ensure timely resolution of defects",
        ],
      },
      {
  ...
  es: {
    ...
    aboutMeContent:
      "Mentalidad analítica con gran interés en el diseño UX/UI y la visualización de datos utilizando herramientas como Power BI. Participa activamente en comunidades de QA y está comprometido con el aprendizaje continuo en tecnologías emergentes. Apasionado por impulsar la innovación en Aseguramiento de Calidad, ecosistemas IoT y prácticas de seguridad de datos.",
    experiences: [
      {
        ...
        details: [
          ...
          "Validé los criterios de aceptación y funcionalidades del producto mediante rigurosas pruebas E2E y de regresión",
      ...
      },
      {
        ...
        status: "completed",
        details: [
          "Lideré actividades de QA en múltiples proyectos en los sectores farmacéutico y de salud",
          ...
          "Mentoricé a ingenieros de QA junior y contribuí a las evaluaciones de desempeño",
        ],
      },
      {
      ...
      },
      {
        ...
        details: [
          ...
          "Realicé pruebas A/B, de integración, regresión y E2E; reporté hallazgos usando scripts de Python",
    ...
    education: [
      {
        title: "Posgrado: Gobernanza y Cumplimiento de Datos",
        institution: "Universidad de Buenos Aires",
        year: "2024",
        focus: "Ética de Datos, Ciberseguridad, E-Discovery",
      },
      {
        title: "Diplomado: Blockchain Legal y Criptoactivos",
        institution: "UCEMA",
        year: "2023",
      },
      {
        title: "Nivel Básico ISTQB®",
        institution: "ISTQB",
        year: "2020",
      },
      {
        title: "ScrumMaster® Certificado (CSM)",
        institution: "UTN",
        year: "2019",
      },
      {
        title: "Título de Abogado (equivalente a JD)",
